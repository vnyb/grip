...
class TestPasswordHash:
    def test_returns_argon2_encoded_string(self) -> None:
...
class TestPasswordCheckStrength:
    ...
    def test_insufficient_complexity(self) -> None:
